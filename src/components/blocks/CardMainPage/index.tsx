...
import CardMainPageLoader from "../CardMainPageLoader";
import s from "./CardMainPage.module.scss";

type TSerialNumber = {
  serialNumber: number;
};

const CardMainPage: React.FC<TSerialNumber> = ({ serialNumber }) => {
  const { data, isLoading } = useGetLonelyNewsQuery(serialNumber && serialNumber);
